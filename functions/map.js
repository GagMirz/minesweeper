...
export const fillMines = (gameObj) => {
    ...
    for (let i = 0; i <= (gameObj.width * gameObj.height / 6); ++i) {
        ...
        //greater then 2 it's not neighbor cell
